...
- (void)createViews
{
    ...
    if (!toolbarIsAtBottom) {
        toolbarHeight = IsAtLeastiOSVersion(@"7.0") ? TOOLBAR_HEIGHT+20 : TOOLBAR_HEIGHT;
    }
    ...
    self.toolbar.barTintColor = [UIColor colorWithRed:91/255.0 green:205/255.0 blue:197/255.0 alpha:1];
